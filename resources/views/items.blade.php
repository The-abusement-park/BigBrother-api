    ...
    <table class="table">
        ...
        @foreach($items as $item)
            <tr>
                ...
                @endif
                <td>
                    <button class="btn btn-danger" onclick="removeItem({{$item->id}})">Verwijderen</button>
                    <button class="btn btn-primary"  onclick="assignItem({{$item->id}})">Toewijzen aan mij</button>
                </td>
            </tr>
        @endforeach
        </tbody>
